...
def get_model_choice():
    ...
    print("\nAvailable models:")
    print("1. Qwen Image Training Models")
    ...
    print("   Default directory: Training_Models_Qwen")
    print()
    print("3. Wan 2.1 Text to Video Training Models")
    ...
    print()
    print("4. Wan 2.2 Text to Video Training Models")
    print("   - Wan2_1_VAE_bf16.safetensors")
    print("   - umt5-xxl-enc-bf16.safetensors")
    ...
    print("   Default directory: Training_Models_Wan")
    print()
    print("5. Wan 2.2 Image to Video Training Models")
    print("   - Wan2_1_VAE_bf16.safetensors")
    print("   - umt5-xxl-enc-bf16.safetensors")
    print("   - Wan-2.2-I2V-Low-Noise-BF16.safetensors")
    print("   - Wan-2.2-I2V-High-Noise-BF16.safetensors")
    print("   Default directory: Training_Models_Wan")
    print()

    while True:
        try:
            choice = input("Please select model (1-5): ").strip()
            if choice == "1":
                return "qwen_image"
            elif choice == "2":
...
def download_models(model_id: Optional[str] = None, download_dir: Optional[str] = None):
    ...
    files = scan_repo_files(repo_id, files_to_download)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', choices=['qwen_image', 'qwen_image_edit_plus', 'wan21_t2v', 'wan22_t2v', 'wan22_i2v'],
                       help='Model to download: qwen_image (Qwen Image Training), qwen_image_edit_plus (Qwen Image Edit Plus 2509), wan21_t2v (Wan 2.1 Text-to-Video), wan22_t2v (Wan 2.2 Text-to-Video), or wan22_i2v (Wan 2.2 Image-to-Video)')
    parser.add_argument('--dir', type=str,
                       help='Download directory (supports both full and relative paths for Windows and Linux)')

    args = parser.parse_args()
    
    # If no model specified, let user choose interactively
    if not args.model:
        ...
        print("  --model wan22_t2v          : Download Wan 2.2 Text-to-Video Training Models")
        print("  --model wan22_i2v          : Download Wan 2.2 Image-to-Video Training Models")
        print()
